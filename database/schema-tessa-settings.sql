...
CREATE INDEX IF NOT EXISTS idx_tessa_questions_asked_at ON tessa_questions(asked_at);
CREATE INDEX IF NOT EXISTS idx_tessa_questions_is_saved ON tessa_questions(is_saved);
