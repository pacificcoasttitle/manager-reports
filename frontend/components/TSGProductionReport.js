...
export default function TSGProductionReport({ data }) {
  ...
  return (
    <div>
      <div className="report-meta">
        ...
        <span style={{ color: '#f26b2b', fontWeight: 600 }}>Trustee Sale Guarantee orders only</span>
      </div>
        ...
        <table className="report-table">
          <thead>
            <tr>
              ...
              <th className="col-tsg">Today Cnt</th><th className="col-tsg">Today Rev</th>
              <th className="col-tsg">MTD Cnt</th><th className="col-tsg">MTD Rev</th>
              <th className="col-tsg">Prior Cnt</th><th className="col-tsg">Prior Rev</th>
