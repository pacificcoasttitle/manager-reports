  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f5f5f5;">
    <tr><td align="center" style="padding:20px 10px;">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#fff; border-radius:8px; overflow:hidden; box-shadow:0 2px 8px rgba(0,0,0,0.08);">
        ...
        <tr><td style="background:#03374f; padding:24px 30px;">
          <div style="font-size:18px; font-weight:700; color:#fff;">Pacific Coast Title</div>
          <div style="font-size:13px; color:#8db4d4; margin-top:4px;">Daily Production Report</div>
        </td></tr>
        ...
        <tr><td style="padding:16px 30px 8px;">
          <div style="font-size:14px; font-weight:700; color:#03374f; margin-bottom:12px;">Yesterday</div>
        ...
        <tr><td style="padding:16px 30px 8px;">
          <div style="font-size:14px; font-weight:700; color:#03374f; margin-bottom:4px;">Month to Date</div>
          <div style="font-size:12px; color:#868e96; margin-bottom:12px;">${monthNames[month]} 1\u2013${yesterday.getDate()} \u00b7 ${worked} of ${totalDays} working days</div>
          <table width="100%" cellpadding="0" cellspacing="0" style="font-size:13px;">
        ...
        <tr><td style="padding:24px 30px; text-align:center;">
          <div style="font-size:11px; color:#adb5bd;">Pacific Coast Title \u00b7 Your title production \u00b7 Generated automatically</div>
        </td></tr>
