      ...
      <main className="main-content">
        ...
        {!loading && !error && (
          <div className="report-container">
            ...
            {activeTab === 'tessa' && <TessaPlaceholder />}
...
function TessaPlaceholder() {
  return (
    <div style={{ padding: '40px 0', textAlign: 'center', color: '#868e96' }}>
      <div style={{ fontSize: '40px', marginBottom: '12px' }}>🟠</div>
      <h2 style={{ fontSize: '18px', fontWeight: 700, color: '#343a40', marginBottom: '4px' }}>Ask Tessa</h2>
      <p style={{ fontSize: '13px' }}>AI-powered data Q&A — coming next</p>
    </div>
  );
}
...
function SettingsPlaceholder() {
  return (
    <div style={{ padding: '40px 0', textAlign: 'center', color: '#868e96' }}>
      ...
      <h2 style={{ fontSize: '18px', fontWeight: 700, color: '#343a40', marginBottom: '4px' }}>Settings</h2>
      <p style={{ fontSize: '13px' }}>KPI preferences, email configuration — coming next</p>
    </div>
  );
}
